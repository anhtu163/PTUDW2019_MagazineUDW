...
CREATE TABLE IF NOT EXISTS `category` (
  ...
  PRIMARY KEY (`CatID`),
  KEY `FK_category_group_category` (`GroupID`),
  CONSTRAINT `FK_category_group_category` FOREIGN KEY (`GroupID`) REFERENCES `group_category` (`GroupID`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8;

-- Dumping data for table magazine.category: ~9 rows (approximately)
/*!40000 ALTER TABLE `category` DISABLE KEYS */;
INSERT INTO `category` (`CatID`, `CatName`, `GroupID`) VALUES
	(1, 'Xã hội', 1),
	(2, 'Khoa học - Công nghệ', 2),
	(3, 'Pháp luật', 1),
	(4, 'Giáo dục', 1),
	(5, 'FunFact', 2),
	(6, 'Du lịch', 1),
...
-- Dumping structure for table magazine.group_category
...
-- Dumping data for table magazine.group_category: ~0 rows (approximately)
/*!40000 ALTER TABLE `group_category` DISABLE KEYS */;
INSERT INTO `group_category` (`GroupID`, `GroupName`) VALUES
	(1, 'group1'),
	(2, 'group2');
